...
public class CustomerPanel extends JPanel {
    ...
    private JPanel labeledSearch() {
        ...
        btnAdd.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Chức năng thêm Khách hàng đang cập nhật!");
        });
    ...
    private JPanel buildBottomBar() {
        ...
        btnEdit.addActionListener(e -> {
            ...
            if (row < 0) { JOptionPane.showMessageDialog(this, "Chọn khách hàng để sửa!"); return; }
            JOptionPane.showMessageDialog(this, "Chức năng sửa Khách hàng đang cập nhật!");
        });
        ...
        btnDelete.addActionListener(e -> {
            int row = table.getSelectedRow();
            if (row < 0) { JOptionPane.showMessageDialog(this, "Chọn khách hàng để xóa!"); return; }
            KhachHang kh = currentPageData.get(row);
            int confirm = JOptionPane.showConfirmDialog(this, "Xác nhận xóa khách hàng " + kh.getHoTen() + "?", "Xác nhận", JOptionPane.YES_NO_OPTION);
