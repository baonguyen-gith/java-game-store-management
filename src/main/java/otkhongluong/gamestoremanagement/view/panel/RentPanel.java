...
public class RentPanel extends JPanel {
    ...
    private JPanel buildTopBar() {
        ...
        btnReturn.addActionListener(e -> {
            ...
            if (row < 0) {
                JOptionPane.showMessageDialog(this, "Vui lòng chọn phiếu thuê cần trả CD!");
                return;
            }

            String trangThai = tableModel.getValueAt(row, 6).toString(); // cột "Trạng thái"
            if (!"DangThue".equalsIgnoreCase(trangThai)) {
                JOptionPane.showMessageDialog(this,
                    "Phiếu thuê này đã được trả rồi!\nChỉ có thể trả CD với phiếu đang thuê.",
    ...
    private JPanel buildBottomBar() {
        ...
        RoundButton btnExportPDF = new RoundButton("Xuất Phiếu", new Color(234, 88, 12), Color.WHITE);
        btnExportPDF.setPreferredSize(new Dimension(118, 38));
        btnExportPDF.addActionListener(e -> {
            ...
            // Cột 0 là MaPT — kiểm tra lại index theo JTable của bạn
            int maPT = Integer.parseInt(table.getValueAt(row, 0).toString()
                .replace("PT", "").trim());
            ...
            try {
                controller.exportRentalPDF(maPT, path);
                JOptionPane.showMessageDialog(this,
                    "Xuất phiếu thuê thành công!\n" + path, "OK",
        ...
        btnDelete.addActionListener(e -> {
            ...
            boolean ok = controller.deleteRental(id);
