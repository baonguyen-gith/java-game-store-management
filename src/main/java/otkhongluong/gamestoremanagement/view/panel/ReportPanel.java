...
public class ReportPanel extends JPanel {
    ...
    private JPanel buildCDStatus() {
        ...
        kpiRow.add(makeKPICard("Sẵn sàng",       String.valueOf(k.sanSang),   "Có thể cho thuê", COLOR_CUSTOMER, "✔"));
        kpiRow.add(makeKPICard("Đang thuê",      String.valueOf(k.dangThue),  "Khách đang giữ",  COLOR_RENT,     "↗"));
        kpiRow.add(makeKPICard("Đã bán / Hỏng", String.valueOf(k.daBanHong), "Không còn dùng",  COLOR_OVERDUE,  "✖"));
    ...
    private JPanel buildVIP() {
        ...
        for (ReportController.VIPRow r : ctrl.getVIPCustomers()) {
            model.addRow(new Object[]{
                r.medal, r.hoTen, r.sdt, r.email, r.diemTichLuy,
